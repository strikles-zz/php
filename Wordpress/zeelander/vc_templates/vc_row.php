...
// voor Nationaal Huidcentrum altijd full width gebruiken:
// $full_width = true;

$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'vc_row wpb_row ' . ( $this->settings( 'base' ) === 'vc_row_inner' ? 'vc_inner ' : '' ) . get_row_css_class() . $el_class . vc_shortcode_custom_css_class( $css, ' ' ), $this->settings['base'], $atts );
$style = $this->buildStyle( $bg_image, $bg_color, $bg_image_repeat, $font_color, $padding, $margin_bottom ); ?>
<?php //echo $el_class; echo strpos($el_class, 'container-fluid');?>
<div class="container<?php  echo (empty( $full_width ) && strpos($el_class, 'container-fluid') === false) ? '' : '-fluid';?> <?php echo trim( $el_class . vc_shortcode_custom_css_class( $css, ' ' ) );?>">
...
echo '<div class="vc_row-full-width">1</div>';
