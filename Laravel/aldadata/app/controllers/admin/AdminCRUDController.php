...
class AdminCRUDController extends BaseController {
    ...
    public function postCreate() {
        ...
        if ($input_validation !== true) {
            ...
            return View::make('admin/' . $this->name . '/create', compact('title', 'controller'))->with('error', 'Not saved!');
        };

        $model = $this->saveModel();
        $this->populateForm($model);

        return Redirect::to('admin/'.$this->name . '/' . $model->id . '/edit')->with('success', 'Saved!');
    ...
    public function postEdit($model) {
        ...
        if ($input_validation !== true) {
            $this->populateForm();
            Former::withErrors($input_validation);
            return View::make('admin/' . $this->name . '/edit', compact('title', 'model', 'controller'))->with('error', 'Not saved!');
        };
        ...
        return View::make('admin/' . $this->name . '/edit', compact('title', 'model', 'controller'))->with('success', 'Saved!');
    ...
    public function getIframe() {
         return View::make('admin/layouts/iframe')->withTitle('iframe');
    }

    /* GET DETAILS FOR SEARCH PAGES */
    public function getDetails($model) {

        $view = View::make('admin/' . $this->name . '/details');
