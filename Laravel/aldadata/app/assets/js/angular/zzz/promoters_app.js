...
(function (angular, _) {
    ...
    // =============================================================================
    var promoter_app = angular.module('promotersApp', ['ngAnimate', 'ngResource', 'ui.router', 'angular.filter', 'ui.bootstrap', 'dialogs', 'angularFileUpload', 'highcharts-ng']);
    ...
    // =============================================================================
    promoter_app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function($stateProvider, $urlRouterProvider, $locationProvider) {
