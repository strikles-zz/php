...
// https://github.com/laravel/framework/issues/5938
Route::filter('ajaxAuth', function()
{
    if (!Auth::check()) return Response::make(null,401);
});
...
{
    if (Auth::guest() && !Request::ajax()) // If the user is not logged in
    {
...
{
    if(Route::current()->getUri() === "webhooks_worklogs")
    {
        return;
    }
