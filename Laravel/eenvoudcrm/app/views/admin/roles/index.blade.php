	...
	<div class="page-header">
		<h3>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('admin/users/create') }}}" class="btn btn-small btn-info iframe" data-auth="true" data-type="roles" data-action="create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
