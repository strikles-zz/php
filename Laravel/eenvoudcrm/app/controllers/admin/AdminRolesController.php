...
class AdminRolesController extends AdminController {
    ...
    public function getData()
    {
        ...
        ->add_column('actions', '<a href="{{{ URL::to(\'admin/roles/\' . $id . \'/edit\' ) }}}" class="iframe btn btn-xs btn-default" data-auth="true" data-type="roles" data-action="edit" data-id="{{{ $id }}}">{{{ Lang::get(\'button.edit\') }}}</a>
                                <a href="{{{ URL::to(\'admin/roles/\' . $id . \'/delete\' ) }}}" class="modal-popup btn btn-xs btn-danger">{{{ Lang::get(\'button.delete\') }}}</a>
                    ')
