...
class AdminUsersController extends AdminController {
    ...
    public function postCreate()
    {
        ...
        $this->user->roadmap_resource_id = Input::get( 'roadmap_resource_id' );
    ...
    public function getEdit($user)
    {
        if ( $user->id )
        {
        	...
        	return View::make('admin/users/create', compact('user', 'roles', 'permissions', 'title', 'mode'));
        }
        else
        {
    ...
    public function getData()
    {
        ...
        ->add_column('actions', '<a href="{{{ URL::to(\'admin/users/\' . $id . \'/edit\' ) }}}" class="iframe btn btn-xs btn-default" data-auth="true" data-type="users" data-action="edit" data-id="{{{ $id }}}">{{{ Lang::get(\'button.edit\') }}}</a>
                                @if($username == \'admin\')
                                @else
                                    <a href="{{{ URL::to(\'admin/users/\' . $id . \'/delete\' ) }}}" class="modal-popup btn btn-xs btn-danger">{{{ Lang::get(\'button.delete\') }}}</a>
                                @endif
            ')
