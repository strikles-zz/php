...
var assets = {
    ...
    vendor: {
        scss: ['app/assets/vendor/vendor.scss'],
        bootstrap: {
            //scss: ['src/vendor/bootstrap.scss'],
            fonts: ['app/assets/vendor/bootstrap-sass/assets/fonts/bootstrap/*']
        },
        fontawesome: {
            //scss: ['src/vendor/font-awesome/scss/font-awesome.scss'],
            fonts: ['app/assets/vendor/font-awesome-sass-master/assets/fonts/font-awesome/*']
        }
    }
};
